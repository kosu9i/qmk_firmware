...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_minila(
        ...
        MO(1),   KC_LALT, KC_LGUI,  KC_LANG2,                           KC_SPC,  KC_LANG1, KC_RGUI, MO(2),  KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [1] = LAYOUT_minila(
        ...
        _______, RGB_RMOD, _______, BL_DEC,  BL_TOGG, BL_INC,  _______, KC_1,    KC_2,    KC_3,    _______, _______, KC_PGUP, _______,
        _______, _______,  _______, _______,                            _______, KC_0, KC_PDOT,    _______, KC_HOME, KC_PGDN, KC_END 
    ),

    [2] = LAYOUT_minila(
        _______, KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______,
        _______, RGB_TOG,  RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, _______,
        _______, RGB_MOD,  _______, _______, _______, _______, KC_BSPC, KC_4,    KC_5,    KC_6,    _______, _______, _______,
