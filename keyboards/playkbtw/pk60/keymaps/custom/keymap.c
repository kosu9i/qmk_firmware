...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_minila(
        ...
        _______, RGB_MOD,  _______, _______, RGB_VAI, RGB_VAD, _______, KC_4,    KC_5,    KC_6,    _______, _______, _______,
        _______, RGB_RMOD, _______, BL_DEC,  BL_TOGG, BL_INC,  _______, KC_1,    KC_2,    KC_3,    _______, _______, KC_VOLU, _______,
        _______, _______,  _______, _______,                            _______, KC_0, _______, _______, KC_SLCK, KC_VOLD, KC_PAUS 
    ),
